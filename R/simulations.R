...
one.simu <- function(i, N = 10^5, sdEta2 = 0.4, sdNu2 = 0.3, phi = 0.2, nbSeg = 10, jumpSize = 2, nbK = 10)
{
  y <- dataRWAR(N = N,
  ...
  colnames(df) <- c("index", "n", "sdEta2", "sdNu2", "phi", "nbK", "nbSeg", "jumpSize", "sdEta2Est%", "sdNu2Est%", "phiEst_error")
